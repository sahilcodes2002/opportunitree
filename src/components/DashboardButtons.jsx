...
export function Button1() {
  ...
  return (
    ...
    }}  className="w-fit flex justify-center shadow-lg  rounded-lg cursor-pointer bg-gradient-to-b from-blue-300 via-blue-200  to-blue-300 hover:border-2 hover:shadow-mytext">
...
export function Button2() {
  ...
  return (
    ...
    }} className=" mb-2 md:mb-0 w-fit flex justify-center p-[5px] shadow-lg rounded-lg cursor-pointer bg-gradient-to-b from-blue-300 via-blue-200  to-blue-300 hover:border-2 hover:shadow-mytext">
      <div className="flex justify-evenly">
        <div className="flex justify-between">
...
export function Button3() {
  ...
  return (
    <div onClick={()=>{
      navigate("/allcode")
    }} className="w-fit flex justify-center p-[5px] shadow-lg rounded-lg cursor-pointer bg-gradient-to-b from-blue-300 via-blue-200  to-blue-300 hover:border-2 hover:shadow-mytext">
      <div className="flex justify-evenly">
        <div className="flex justify-between">
          <div className="flex flex-col justify-center ml-5">
            <img
